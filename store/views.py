...
def register(request):
    ...
    try:
        ...
        print(messages.error(request, f'Error: {str(e)}'))
    ...
    if request.method=='POST':
        ...
        try:
            ...
            if user is not None:
                ...
                messages.warning(request,'User is no exist,creat one!!!')
        except:
    ...
    if cart_data:
        for p_id, item in cart_data.items():
            ...
            try:
                ...
                pass
        return render(request,'new cart/payapl-completed.html',{'cart_data':cart_data,'totalcartitems':cart_data,'cart_total_amount':cart_total_amount ,"total":total})
